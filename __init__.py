...
class FamilyCentralSkill(OVOSCommonPlaybackSkill):
    ...
    def initialize(self):
        url = "https://www.youtube.com/channel/UCvRI1Nyvj9pAyHPzX7AviWQ"
    ...
    def match_skill(self, phrase, media_type):
        ...
        if self.voc_match(phrase, "movie") or media_type == MediaType.MOVIE:
            score += 10
        if self.voc_match(phrase, "family"):
            score += 50
    ...
    def normalize_title(self, title):
        ...
        title = self.remove_voc(title, "family")
    ...
    def search_db(self, phrase, media_type):
        ...
        if self.voc_match(phrase, "familycentral"):
